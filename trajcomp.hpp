...
class douglas_peucker_impl
{
	...
	element_segment_distance<typename TrajectoryType::ElementType, DistanceType> *d;
public:
...
DistanceType largest_contribution(TrajectoryType &u, size_t istart, size_t iend,size_t &the_index)
   {
	...
	typename TrajectoryType::ElementType s = u[istart];	
	typename TrajectoryType::ElementType e = u[iend];
            ...
            element_segment_distance<typename TrajectoryType::ElementType,DistanceType> &d)
  {
	...
	TrajectoryType ret(u.dimension);
...
element_segment_distance<typename TrajectoryType::ElementType,double> &d)
{
